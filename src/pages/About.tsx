...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-20">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">A Journey from Scholar to Tech Innovator</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">Islamic Scholar & Tech Entrepreneur</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Award className="w-4 h-4 text-islamic-green-600 dark:text-islamic-green-400" />
                      <span className="text-gray-700 dark:text-gray-300">Founder & CEO, IPS Technologies</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div>
              <h3 className="text-2xl font-elegant font-semibold text-islamic-green-800 dark:text-islamic-green-400 mb-4">
                Vision & Mission
              </h3>
