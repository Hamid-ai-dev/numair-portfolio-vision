...
const Education = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-50 to-yellow-50 dark:from-gray-900 dark:to-gray-800 pt-20">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">Academic Excellence in Islamic Studies & Technology</p>
          </div>
